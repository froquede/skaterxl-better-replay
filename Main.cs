        ...
        private static void OnGUI(UnityModManager.ModEntry modEntry)
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                GUILayout.BeginVertical(GUILayout.Width(256));
                {
                    ...
                    settings.handle_size = RGUI.SliderFloat(settings.handle_size, 0f, 64f, 25f, "Size");
                    settings.handle_color.a = (byte)RGUI.SliderFloat(settings.handle_color.a, 0f, 255f, 0f, "Opacity");
                    settings.handle_color.r = (byte)RGUI.SliderFloat(settings.handle_color.r, 0f, 255f, 0f, "Red");
                    settings.handle_color.g = (byte)RGUI.SliderFloat(settings.handle_color.g, 0f, 255f, 0f, "Green");
                    settings.handle_color.b = (byte)RGUI.SliderFloat(settings.handle_color.b, 0f, 255f, 0f, "Blue");
